...
C $Header: /project/yoj/arc/CCTM/src/util/util/get_envlist.f,v 1.2 2011/10/21 16:11:37 yoj Exp $
...
201   CONTINUE
      ...
      IF ( IP .GT. MAX_LEN ) THEN
         XMSG = 'Environment variable value too long'//E_VAL
